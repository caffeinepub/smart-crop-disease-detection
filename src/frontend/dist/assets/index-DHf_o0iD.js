...
const translations = {
  en: {
    ...
    home: {
      ...
      subheading: "This system uses AI and camera-based image analysis to detect crop diseases at an early stage.",
      feature1Title: "Early Detection",
      feature1Desc: "Identify diseases before they spread and cause major crop loss.",
      feature2Title: "Low-Cost Solution",
      feature2Desc: "Affordable AI-powered analysis accessible to every farmer.",
    ...
    detection: {
      ...
      vizNote: "This is AI-based analysis for early disease detection and approximate estimation.",
    ...
    feedback: {
      ...
      textPlaceholder: "Tell us your problem or suggestion to improve this system",
    ...
    footer: {
      ...
      copyright: `© ${(/* @__PURE__ */ new Date()).getFullYear()} Smart Crop Disease Detection System. Built with love using caffeine.ai`
    }
  },
  te: {
    nav: {
    ...
    home: {
      ...
      subheading: "ఈ వ్యవస్థ AI మరియు కెమెరా ఆధారిత చిత్ర విశ్లేషణను ఉపయోగించి పంట వ్యాధులను ముందస్తుగా గుర్తిస్తుంది.",
    ...
    footer: {
      ...
      copyright: `© ${(/* @__PURE__ */ new Date()).getFullYear()} స్మార్ట్ పంట వ్యాధి నిర్ధారణ వ్యవస్థ`
    }
  },
  hi: {
    nav: {
    ...
    home: {
      ...
      subheading: "यह प्रणाली AI और कैमरा-आधारित छवि विश्लेषण का उपयोग करके फसल रोगों को प्रारंभिक अवस्था में पहचानती है।",
    ...
    footer: {
      ...
      copyright: `© ${(/* @__PURE__ */ new Date()).getFullYear()} स्मार्ट फसल रोग पहचान प्रणाली`
    }
  }
};
...
function LanguageProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LanguageContext.Provider, { value: { lang, setLang, t: translations[lang] }, children });
}
...
function AnimatedBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm font-semibold mb-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-muted rounded-full h-5 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `h-full ${color} rounded-full progress-bar flex items-center justify-end pr-2`,
        style: { width: `${width}%` },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs font-bold", children: width > 10 ? `${pct}%` : "" })
      }
    ) })
  ] });
}
function CropHealthSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "crop-health", className: "py-16 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl md:text-4xl font-bold text-foreground text-center mb-10", children: [
      "🌾 ",
      t.cropHealth.sectionTitle
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 mb-10", children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-display font-bold mb-1", children: stat.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium opacity-80", children: stat.label })
        ]
      },
      stat.key
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl p-6 md:p-8 shadow-sm border border-border space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-4 h-32 justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: t.cropHealth.healthy })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: t.cropHealth.infected })
        ] })
      ] }) })
    ] })
  ] }) });
...
const Coins = createLucideIcon("coins", __iconNode$9);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function DeviceStatusSection() {
  ...
  const cards = [
    {
      key: "battery",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Battery, { size: 28, className: "text-green-500" }),
      label: t.deviceStatus.battery,
      value: "82%",
      sub: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-muted rounded-full h-3 mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    {
      key: "status",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { size: 28, className: "text-primary" }),
      label: t.deviceStatus.status,
      value: t.deviceStatus.statusScanning,
      sub: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 bg-green-400 rounded-full scanning-dot" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-green-600 font-medium", children: t.deviceStatus.statusScanning })
      ] })
    },
    {
      key: "scan",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 28, className: "text-accent" }),
    ...
    {
      key: "mode",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 28, className: "text-orange-500" }),
      label: t.deviceStatus.mode,
      value: "Simulation",
      sub: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-orange-100 text-orange-700 text-xs font-bold px-2 py-1 rounded-full mt-2", children: "Simulation Mode" })
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "device-status", className: "py-16 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl md:text-4xl font-bold text-foreground text-center mb-6", children: [
      "📡 ",
      t.deviceStatus.sectionTitle
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-orange-50 border border-orange-200 rounded-2xl px-6 py-4 mb-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-orange-700 font-semibold text-base", children: t.deviceStatus.simBanner }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: cards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
            card.icon,
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm font-medium", children: card.label })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold text-foreground", children: card.value }),
          card.sub
        ]
      },
      card.key
...
function VisualizationPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[oklch(0.10_0.03_145)] rounded-2xl p-4 md:p-6 mt-4 border border-primary/30", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-white font-display text-xl font-semibold mb-4 text-center", children: [
      "🔬 ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-300 text-sm font-semibold mb-2 text-center", children: t.detection.originalImg }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative rounded-xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: imageSrc,
            alt: "Original leaf",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-300 text-sm font-semibold mb-2 text-center", children: t.detection.processedImg }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 justify-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 rounded-full bg-red-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-300", children: t.detection.legendDiseased })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 rounded-full bg-green-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-300", children: t.detection.legendHealthy })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-400 font-semibold", children: t.detection.healthyLabel }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-400 font-bold", children: [
            healthyPct,
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-white/10 rounded-full h-4 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-400 font-semibold", children: t.detection.diseasedLabel }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-3 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 rounded-xl p-3 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs mb-1", children: t.detection.affectedArea }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-red-400 font-bold text-xl", children: [
          diseasedPct,
          "%"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 rounded-xl p-3 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs mb-1", children: t.detection.diseaseName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-yellow-300 font-bold", children: diseaseName })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/5 rounded-xl p-3 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs mb-1", children: t.detection.treatment }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-300 text-sm", children: treatment.split(".")[0] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs italic text-center", children: t.detection.vizNote })
  ] });
}
const demoDiseases = [
  {
    ...
    affectedPct: 35,
    healthyPct: 65,
    treatment: "Apply Mancozeb fungicide spray. Remove infected leaves immediately. Improve air circulation.",
  ...
  },
  {
    ...
    affectedPct: 28,
    healthyPct: 72,
    treatment: "Apply Propiconazole or Tebuconazole fungicide at first sign of infection.",
    imageSrc: "/assets/generated/wheat-rust.dim_600x400.jpg"
  }
];
function DiseaseCard({ d }) {
  const { t } = useLanguage();
  const [showViz, setShowViz] = reactExports.useState(false);
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bg-red-500 text-white text-xs font-bold px-2 py-1 rounded-full", children: [
            t.detection.affectedArea,
            ": ",
            d.affectedPct,
            "%"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 right-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bg-primary text-white text-xs font-bold px-2 py-1 rounded-full", children: [
            d.confidence,
            "% ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-foreground text-lg", children: d.plant }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm", children: [
                t.detection.diseaseName,
                ":",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-500 font-semibold", children: d.disease })
              ] })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: showViz ? t.detection.hideAnalysis : t.detection.viewAnalysis
            }
          ),
          showViz && /* @__PURE__ */ jsxRuntimeExports.jsx(
            VisualizationPanel,
            {
              imageSrc: d.imageSrc,
...
function DiseaseDetectionSection() {
  ...
  const [showUploadViz, setShowUploadViz] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "disease-detection", className: "py-16 bg-secondary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl md:text-4xl font-bold text-foreground text-center mb-2", children: [
      "🦠 ",
      t.detection.sectionTitle
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-muted-foreground mb-10", children: t.detection.uploadHint }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mb-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-3 text-sm", children: t.detection.uploadHint })
    ] }),
    analyzing && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        "data-ocid": "detection.loading_state",
        className: "flex flex-col items-center gap-3 py-10",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 48, className: "text-primary animate-spin" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-semibold text-lg", children: t.detection.analyzing })
        ]
      }
    ),
    showResult && uploadedImage && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        "data-ocid": "detection.success_state",
        className: "max-w-3xl mx-auto mb-12",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl shadow-lg border border-primary/30 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/10 px-6 py-4 border-b border-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display text-xl font-bold text-primary flex items-center gap-2", children: [
            "✅ ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 grid grid-cols-2 gap-3", children: resultItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "bg-secondary/50 rounded-xl p-3",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mb-1", children: item.label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `font-bold text-lg ${item.color}`, children: item.value })
                  ]
                },
                item.key
              )) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 bg-secondary/50 rounded-xl p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-semibold mb-1", children: t.detection.treatment }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground text-sm", children: "Apply Mancozeb fungicide spray. Remove infected leaves immediately. Improve air circulation." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: showUploadViz ? t.detection.hideAnalysis : t.detection.viewAnalysis
              }
            ),
            showUploadViz && /* @__PURE__ */ jsxRuntimeExports.jsx(
              VisualizationPanel,
              {
                imageSrc: "/assets/generated/tomato-late-blight.dim_600x400.jpg",
                healthyPct: 65,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-semibold text-foreground mb-6 text-center", children: t.detection.demoTitle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto", children: demoDiseases.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(DiseaseCard, { d }, d.id)) })
    ] })
  ] }) });
}
const diseases = [
...
function InfoRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-xs font-bold uppercase tracking-wide ${color}`, children: [
      label,
      ":",
      " "
    ] }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-display font-bold text-lg", children: d.plant }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full", children: d.disease })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            InfoRow,
            {
          ...
          expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              InfoRow,
              {
...
function DiseaseLibrarySection() {
  const { t } = useLanguage();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "disease-library", className: "py-16 bg-secondary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl md:text-4xl font-bold text-foreground text-center mb-10", children: [
      "📚 ",
      t.diseaseLibrary.sectionTitle
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto", children: diseases.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(DiseaseLibraryCard, { d }, d.id)) })
  ] }) });
}
function GuidanceCard({ title, steps, bgColor, iconBg }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: steps.map((step, i) => (
          // biome-ignore lint/suspicious/noArrayIndexKey: steps are static translation strings
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 w-7 h-7 bg-white rounded-full flex items-center justify-center text-sm font-bold text-primary shadow-sm mt-0.5", children: i + 1 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground text-base leading-relaxed", children: step })
          ] }, i)
        )) })
      ]
    }
...
function FarmerGuidanceSection() {
  const { t } = useLanguage();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "farmer-guidance", className: "py-16 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl md:text-4xl font-bold text-foreground text-center mb-10", children: [
      "👨‍🌾 ",
...
function FeedbackChatbox() {
  const { t } = useLanguage();
  const [open, setOpen] = reactExports.useState(false);
  const [name, setName] = reactExports.useState("");
  const [feedbackLang, setFeedbackLang] = reactExports.useState("en");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-6 right-6 z-50", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary px-4 py-3 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-white font-bold text-base", children: [
              "💬 ",
              t.feedback.title
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-semibold text-base leading-relaxed", children: thankYous[feedbackLang] })
              ]
            }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "te", children: "తెలుగు" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "hi", children: "हिन्दी" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: open ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 24 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { size: 24 })
      }
    )
  ] });
}
function FieldCoverageSection() {
  const { t } = useLanguage();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "field-coverage", className: "py-16 bg-secondary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl md:text-4xl font-bold text-foreground text-center mb-10", children: [
      "🗺️ ",
      t.fieldCoverage.sectionTitle
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: "max-w-2xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl p-8 shadow-sm border border-border text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-medium mb-2", children: t.fieldCoverage.coverage }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-5xl font-bold text-primary mb-6", children: [
        progress,
        "% Scanned"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-muted rounded-full h-8 overflow-hidden mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-sm", children: progress > 15 ? `${progress}%` : "" })
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4", children: [
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mb-1", children: stat.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-foreground", children: stat.value })
          ]
        },
        stat.label
      )) })
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-[oklch(0.18_0.05_145)] text-green-100 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl font-bold text-white", children: "Smart Crop Detection" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-300 mb-3", children: t.footer.tagline }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-400 text-sm mb-4", children: t.footer.contact }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10 pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-green-500 text-xs", children: [
      "© ",
      year,
      ". Built with ❤️ using",
      " ",
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 bg-[oklch(0.44_0.16_145)] shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🌱" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Smart Crop Detection" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: "Crop Detection" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-1", children: navIds.map((id, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: `#${id}`,
          "data-ocid": "nav.link",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex rounded-full bg-white/15 overflow-hidden", children: langOptions.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            "data-ocid": "lang.toggle",
            onClick: () => setLang(opt.code),
            className: `px-3 py-1 text-sm font-semibold transition-colors ${lang === opt.code ? "bg-white text-[oklch(0.44_0.16_145)]" : "text-white hover:bg-white/20"}`,
            children: opt.label
          },
          opt.code
        )) }),
    ...
    menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden bg-[oklch(0.40_0.16_145)] border-t border-white/10 px-4 py-2", children: navIds.map((id, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        href: `#${id}`,
        "data-ocid": "nav.link",
...
function HomeSection() {
  ...
  const features = [
    {
      key: "early",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 32, className: "text-primary" }),
      title: t.home.feature1Title,
      desc: t.home.feature1Desc
    },
    {
      key: "cost",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { size: 32, className: "text-primary" }),
      title: t.home.feature2Title,
      desc: t.home.feature2Desc
    },
    {
      key: "farmer",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(UserCheck, { size: 32, className: "text-primary" }),
      title: t.home.feature3Title,
      desc: t.home.feature3Desc
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "home", className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-[oklch(0.25_0.12_145/0.75)] to-[oklch(0.18_0.10_145/0.85)]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-4 max-w-3xl mx-auto section-fade-in", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-white/20 backdrop-blur rounded-full px-4 py-1.5 text-sm font-medium mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-green-300 scanning-dot inline-block" }),
              "AI-Powered System"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl md:text-5xl font-bold leading-tight mb-4", children: t.home.heading }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-green-100 leading-relaxed mb-8", children: t.home.subheading }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-secondary/50 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        "data-ocid": "home.card",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mb-4", children: f.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold text-foreground mb-2", children: f.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: f.desc })
        ]
      },
      f.key
    )) }) }) })
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LanguageProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(HomeSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DiseaseDetectionSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CropHealthSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FieldCoverageSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DeviceStatusSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DiseaseLibrarySection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FarmerGuidanceSection, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackChatbox, {})
  ] }) });
}
...
Service({
  "getAllDetections": Func([], [Vec(DiseaseDetection)], ["query"]),
  "getCropHealthStats": Func([], [CropHealthStats], ["query"]),
  "getDeviceStatus": Func([], [DeviceStatus], ["query"]),
  "getDiseaseLibrary": Func([], [Vec(DiseaseLibrary)], ["query"]),
  "seedData": Func([], [], []),
  "updateCropHealthStats": Func([Nat, Nat, Nat, Time], [], []),
  "updateDeviceStatus": Func([Nat, Text, Time, Nat], [], [])
});
